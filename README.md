...
* If you're interested in TensorFlow.js, you can train a model in your browser right now.  Here's the blog article explaining everything along the way.  [TFJS in the Browser](https://heartbeat.fritz.ai/using-tensorflow-js-to-train-a-rock-paper-scissors-model-b5f393b548eb), and here's a newsletter to learn more: https://infinite.red/machinelearning
